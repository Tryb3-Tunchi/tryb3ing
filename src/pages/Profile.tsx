           ...
           >
            <button
              ...
              className={`w-full flex items-center space-x-2 px-4 py-2 rounded-lg text-left ${
                activeTab === item.label ? 'bg-blue-50 text-blue-600' : 'text-gray-700 hover:bg-gray-50'
              }`}
            >
      ...
      <div className="flex-1 p-8">
        <div className="max-w-3xl mx-auto">
          <Alert className="mb-6">
            ...
            <AlertDescription>
              This will help us ensure you're aware of the risks related to online trading, and that our products are suitable for you.
            </AlertDescription>
